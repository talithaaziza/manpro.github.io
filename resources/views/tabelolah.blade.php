                ...
                <ul class="show-notification profile-notification">
                  ...
                  <li class="waves-effect waves-light">
                    <a href="auth-normal-sign-in.html">
                      <a href="#" class="dropdown-item {{ route('logout') }}"
        ...
        <div class="pcoded-wrapper">
          <nav class="pcoded-navbar">
            ...
            <div class="pcoded-inner-navbar main-menu">
              ...
              <ul class="pcoded-item pcoded-left-item">
                <li>
                  <a href="{{ route('stok.index') }}" class="waves-effect waves-dark">
              ...
              <ul class="pcoded-item pcoded-left-item">
                <li class="active">
                  <a href="{{ route('olah.index') }}" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="fa fa-th-large"></i><b>B</b></span>
                ...
                <div class="page-wrapper">
                  ...
                  <div class="page-body">
                    ...
                    <div class="col-12 grid-margin">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">Data Olah Barang</h5>
